...
from trading_env2 import Forex_Trading_Env 

def main():
    df = load_and_preprocess_data("/mnt/0498342198341420/UIT_DS_Third_Year_2025_2026/Reinforcement_Learning/Trading_Forex/data/EURUSD_Candlestick_1_Hour_BID_01.07.2020-15.07.2023.csv")

    # Create env 
    env = Forex_Trading_Env(
        df=df, 
        window_size=30,
        sl_options=[30, 60, 90],
        tp_options=[30, 60, 90]
    ...
    model_1 = RecurrentPPO(
        "MlpLstmPolicy",          # Hoặc "CnnLstmPolicy" nếu cần
        vec_env,
        verbose=1,
        tensorboard_log="./tensorboard_log/"
