...
class CryptoRLTrainer:
    ...
    def load_data(self):
        """Load data từ CSV local (1H interval)"""
        print(f"\n{'='*70}")
        print(f"LOADING LOCAL CSV DATA (1H)")
        print(f"{'='*70}\n")
        
        data_dict = {}
        
        for symbol in self.symbol_list:
            # giả sử file dạng: data/BTCUSDT.csv
            filepath = f"/mnt/0498342198341420/UIT_DS_Third_Year_Second_Semester_2025_2026/Reinforcement_Learning/data/{symbol}_1H_full.csv"
            ...
            # 🔥 (optional nhưng nên có) fill missing timestamp
